    ...
    <form method="post" action="${pageContext.request.contextPath }/role/add">
        <table class="table table-condensed table-striped" style="margin-top:25px;font-size:small;">
           ...
           <tr>
              ...
              <td>
                 <input type="hidden" id="resourceIds" name="resouceid" value="${role.resourceid }"/>
                 <input class="l360" type="text" id="resourceName" name="resourceName" <c:if test="${not empty role.resouceid}"> value="${role.resouceid }"</c:if>/>
